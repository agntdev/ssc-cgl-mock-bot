...
const HELP =
  "Use Start test to enter your details, choose a mock, and answer at your pace.\n\n" +
  "Your answers are saved automatically, so you can resume an unfinished test from the menu.";
